...
| [OpenLM](https://laion.ai/blog/open-lm/)<br><sub>**Suchin Gururangan<sup>\*</sup>**, Mitchell Wortsman<sup>\*</sup>, Samir Yitzhak Gadre, Achal Dave, Maciej Kilian, Weijia Shi, Jean Mercat, Georgios Smyrnis, Gabriel Ilharco, Matt Jordan, Reinhard Heckel, Alex Dimakis, Ali Farhadi, Vaishaal Shankar, Ludwig Schmidt<sup>\*</sup><br><sub>Equal Contribution</sub><br><sub>*ICLR 2024*</sub> | <sub><span style="border: 0.5px solid lightgrey; padding: 5px; box-shadow:2px 2px 2px grey; border-radius: 5px; margin-left: 10px; display: inline-block;">[code](https://github.com/mlfoundations/open_lm)</span></sub> |
